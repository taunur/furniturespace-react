    ...
    <div className="w-full md:px-4 md:w-4/12" id="shipping-detail">
      <div className="bg-gray-100 px-4 py-6 md:p-8 md:rounded-3xl">
        <form action="success.html">
          ...
          <div className="flex flex-col mb-4">
            <label htmlFor="inputEmail" className="text-sm mb-2">
              Email Address
            </label>
            <input
              data-input
          ...
          <div className="flex flex-col mb-4">
            <label htmlFor="inputAddress" className="text-sm mb-2">
              Address
            </label>
            <input
              data-input
          ...
          <div className="flex flex-col mb-4">
            <label htmlFor="inputPhoneNumber" className="text-sm mb-2">
              Phone Number
            </label>
            <input
              data-input
          ...
          <div className="flex flex-col mb-4">
            <label htmlFor="inputCompleteName" className="text-sm mb-2">
              Choose Courier
            </label>
          ...
          <div className="flex flex-col mb-4">
            <label htmlFor="inputChoosePayment" className="text-sm mb-2">
              Choose Payment
            </label>
            <div className="flex -mx-2 flex-wrap">
              <div className="px-2 w-6/12 h-24 mb-4">
